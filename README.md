...
# Grupo: Arthur Lara, Lucas Neiss, Kauã Vitor, Rafael Valdivio
...
- perseguição por médicos e enfermeiros;
- redução do campo de visão em momentos de perigo;
- alertas sonoros, como batimentos cardíacos, indicando aproximação dos perseguidores;
- coleta de itens;
- interação com personagens;
- transição entre áreas do hospital;
- narrativa conduzida por diálogos.
