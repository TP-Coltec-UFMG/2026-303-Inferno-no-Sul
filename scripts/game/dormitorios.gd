...
var _falas : Array[Dictionary] = [
	...
	{ "quem": "Doidinho", "texto": "Acordou também? Melhor assim." },
	{ "quem": "Protagonista", "texto": "Quem é você?" },
	{ "quem": "Doidinho", "texto": "Hoje? Depende de quem pergunta." },
	{ "quem": "Doidinho", "texto": "Pra eles, eu sou o Doidinho. Pra você, posso ser a chance de sair daqui." },
	{ "quem": "Protagonista", "texto": "O que está acontecendo?" },
	{ "quem": "Doidinho", "texto": "A luz caiu. Quando a luz cai, as portas ficam menos obedientes." },
	{ "quem": "Doidinho", "texto": "Mas não fica parado. Daqui a pouco eles vêm contar quem ainda tá respirando nesse corredor." },
	{ "quem": "Doidinho", "texto": "Escuta... não é só a gente tentando sair." },
	{ "quem": "", "texto": "O barulho aumenta do lado de fora. Alguém força uma porta. Outra pessoa corre pelo corredor." },
	{ "quem": "Doidinho", "texto": "A cozinha fica depois do pátio. Lá tem coisa útil." },
	{ "quem": "Doidinho", "texto": "Vem comigo. Sem gritar. Sem correr à toa." },
	{ "quem": "Doidinho", "texto": "Vamos ali na cozinha." },
]
